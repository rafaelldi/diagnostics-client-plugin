...
class UpdateGlobalToolAction : NotificationAction(DiagnosticBundle.message("notifications.update.global.tool")) {
    override fun actionPerformed(e: AnActionEvent, notification: Notification) {
        val project = e.project ?: return
        project.lifetime.launchBackground {
            withBackgroundProgress(project, DiagnosticBundle.message("progress.update.global.tool")) {
